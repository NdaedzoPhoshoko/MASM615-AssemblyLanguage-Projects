...
TITLE Program that involves jumps and boolean expressions (myAssignment.asm)
...
isVoting PROC                      ;display that the user is eligible to vote
...
isNotVoting PROC                      ;display that the user is not eligible to vote
